            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title">Cadastro de Conta a Pagar</h3>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="nomeCli" name="nomeCli" placeholder="Seu nome" required>
                            </div>
                            <div class="col-md-4">
                                <label for="sobrenomeCli" class="form-label">Sobrenome</label>
                                <input type="text" class="form-control" id="sobrenomeCli" name="sobrenomeCli" placeholder="Seu sobrenome">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="cpfCli" name="cpfCli" maxlength="14" placeholder="Seu CPF">
                            </div>
                            <div class="col-md-4">
                                <label for="cnpjCli" class="form-label">CNPJ</label>
                                <input type="text" class="form-control cnpj" id="cnpjCli" name="cnpjCli" maxlength="18" placeholder="Ex: 00.000.000/0001-00">
                            </div>
                            <div class="col-md-4">
                                <label for="rgCli" class="form-label">RG (Registro Geral)</label>
                                <input type="text" class="form-control" id="rgCli" name="rgCli" maxlength="12" placeholder="Ex: 00.000.000-0">
                            </div>
                            <div class="col-md-6">
                                <label for="celularCli" class="form-label">Celular</label>
                                <input type="text" class="form-control" id="celularCli" name="celularCli" placeholder="ex: (99) 99999-9999" maxlength="15" required>
                            </div>
                            <div class="col-6">
                                <label for="emailCli" class="form-label">Email</label>
                                <input type="email" class="form-control" name="emailCli" id="emailCli" placeholder="ex: seuemail@exemplo.com" required>
                            </div>
                            <div class="col-md-6">
                                <label for="cepCli" class="form-label">CEP</label>
                                <input type="text" class="form-control" id="cepCli" name="cepCli" maxlength="14" placeholder="ex: 000.000.000-22">
                            </div>
                            <div class="col-md-6">
                                <label for="cidadeCli" class="form-label">Cidade</label>
                                <input type="text" class="form-control" id="cidadeCli" name="cidadeCli" placeholder="ex: Sua Cidade">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="complementocasaCli" name="complementocasaCli" placeholder="ex: Apartamento 456">
                            </div>
                        </div>
                    </div>   
