                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="name_cli_edit" name="name_cli_edit" readonly
                                placeholder="Nome">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="lastname_cli_edit" name="lastname_cli_edit"
                                readonly placeholder="Sobrenome">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="email_cli_edit" name="email_cli_edit" readonly
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="cidade_cli_edit" name="cidade_cli_edit"
                                placeholder="Várzea Paulista">
                        </div>

                        <div class="col-md-2">
                            <label for="uf_cli_edit" class="form-label">UF</label>
                            <input type="text" class="form-control" id="uf_cli_edit" name="uf_cli_edit"
                                placeholder="SP">
                        </div>
