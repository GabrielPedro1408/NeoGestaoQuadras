                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <label for="tipoConta" class="form-label">Categoria</label>
                                <select name="tipoConta" id="tipoConta" required class="form-select">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="recorrencia" id="recorrencia" required class="form-select">
                                    <option disabled selected>Selecione a recorrência</option>
