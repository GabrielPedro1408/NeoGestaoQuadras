                        ...
                        <div class="step">
                            ...
                            <div class="grid">
                                <form class="row g-3" action="" method="POST">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary next" name="cadastrarEmpresa">Cadastrar Empresa</button>
                                    </div>
                                </form>    
                            </div>
                        </div>
                        <div class="step">
                            ...
                            <div class="grid">
                                <form class="row g-3" action="" method="POST">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary next" name="cadastrarUsuario">Cadastrar Usuário</button>
                                    </div>
                                </form>
                            </div>    
                        </div>
