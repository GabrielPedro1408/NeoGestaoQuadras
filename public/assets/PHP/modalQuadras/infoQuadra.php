<div class="modal" id="modalInfo">
            ...
            <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="nomeQuadra"disabled>
                </div>
                <div class="col-md-6">
                    <label for="disponibilidadeQuadra" class="form-label">Disponibilidade</label>
                    <input type="text" class="form-control" id="disponibilidadeQuadra"disabled>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="int" class="form-control" id="valoragendQuadra"disabled>
                </div>
                <div class="col-12">
